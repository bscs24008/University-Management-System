...
public:
    ...
    Teacher(my_string passed_Teacher_id, int salary, const my_string& email, const Date& dob, const Name& name, const Address& addr);
    Teacher& operator=(const Teacher& other);
    my_string get_teacher_id();
    void display(offered_course*& offered_courses, int number_of_courses);
    void initialize_teacher(istream& file);
